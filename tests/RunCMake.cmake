...
#
# Options are passed to the `CMakeLists.txt` with the variable `boostcmake_TEST_OPTIONS`,
# as if those were given on the command line.
#
# If there is a file named "${test}-result.txt", this file is used 
# to source the expected result (the integer returned by running the test) of the test. 
# The default value is "0".
#
# If the variable "RunCMake-stdout-file" (resp. "RunCMake-stderr-file") is set in the 
# current directory, it is read to source the expected output generated by running the test
# on `stdout` (resp. `stderr`). The content of the file is then compared with regular expressions
# with the content of the `stdout` (resp. `stderr`).
# 
# If the variable `boostcmake_TEST_COMMAND` is set, it is used as the test program that is running
function(run_cmake test)
  ...
  # special file for checking the result
